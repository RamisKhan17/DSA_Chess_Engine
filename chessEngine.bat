...
"g++" -std=c++17 -g -I./include src/Board.cpp src/GUI.cpp src/Evaluation.cpp src/Engine.cpp src/Search.cpp chessEngine.cpp -lsfml-graphics -lsfml-window -lsfml-system -o chessEngine
