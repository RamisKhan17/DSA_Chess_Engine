...
"g++" -std=c++17 -g -I./include -I"%SFML_INCLUDE%" -L"%SFML_LIB%" src/Board.cpp src/GUI.cpp src/Evaluation.cpp src/Engine.cpp src/Search.cpp chess.cpp -lsfml-graphics -lsfml-window -lsfml-system -o chess
